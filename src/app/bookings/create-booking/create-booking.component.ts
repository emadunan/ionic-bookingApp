...
export class CreateBookingComponent implements OnInit {
  ...
  onBookPlace() {
    ...
    this.modalCtrl.dismiss({firstName: this.form.value['first-name'],
    lastName: this.form.value['last-name'], guestNumber: this.form.value['guest-number'],
    startDate: this.form.value['date-from'], endDate: this.form.value['date-to'] }, 'confirm');
  }
